# S3 Bucket Configuration with Public Write Access BLOCKED
# This file has been fixed to block public write access while maintaining other test configurations
# FIXED: Public write access is now blocked
...
# FIXED: Changed from public-read-write to private (blocks all public access)
...
# REMOVED: Public bucket policy to block public write access
# Note: Bucket policy removed to prevent public write access
...
output "security_warnings" {
  value = "WARNING: This bucket has no encryption and no versioning. Public write access has been blocked."
}
