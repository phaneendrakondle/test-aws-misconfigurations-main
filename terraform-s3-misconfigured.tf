...
# FIXED: Changed from public-read-write to public-read (blocks public write)
...
# FIXED: Public bucket policy with read-only access (blocks public write)
...
output "security_warnings" {
  value = "NOTE: Public write access has been blocked. Bucket still has public read access, no encryption, and no versioning."
}
