...
# Public write access has been blocked as per security requirements
# This file still contains some security misconfigurations for testing purposes
...
# FIXED: Bucket policy now only allows read access, write access blocked for public
...
output "security_warnings" {
  value = "NOTICE: Public write access has been blocked. Bucket still has other misconfigurations (no encryption, no versioning) for testing purposes."
}
