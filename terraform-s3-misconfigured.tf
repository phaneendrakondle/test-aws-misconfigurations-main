# S3 Bucket Configuration - Public Write Access Fixed
# This file previously contained security misconfigurations
# Public write access has been blocked per security requirements
...
# CONFIGURATION FIXED: Public access block enabled (blocks public access)
...
# CONFIGURATION FIXED: Private ACL (no public access)
...
# CONFIGURATION FIXED: Removed public bucket policy
# Public access is now blocked through the aws_s3_bucket_public_access_block resource
...
output "security_warnings" {
  value = "NOTE: Public write access has been blocked. Bucket still has other misconfigurations: no encryption, and versioning disabled."
}
