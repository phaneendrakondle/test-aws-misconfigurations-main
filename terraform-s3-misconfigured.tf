...
# SECURITY FIX: Changed from public-read-write to private to block public write access
...
output "security_warnings" {
  value = "SECURITY UPDATE: Public write access has been blocked. Bucket now has private ACL and read-only public policy."
}
